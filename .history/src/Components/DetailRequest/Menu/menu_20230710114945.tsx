        ...
        <div>
            <Menu mode="horizontal" className='fixed-menu'>
                ...
                <Modal closable={false} title="Are you sure ?" open={isModalOpenDelete} footer={
                    ...
                    <Checkbox defaultChecked onChange={onChangeCheckbox}>Delete approval tasks related to this request.</Checkbox>
                </Modal>
                ...
                <Modal closable={false} title="Share" open={isModalOpenShare} footer={
                    <div >
                ...
                <Modal className='custom-menu' closable={false} title="Choose User" open={isModalOpenForward} footer={
                    <div >
                    ...
                    <Input style={{ height: '500px' }}></Input>
                </Modal>
