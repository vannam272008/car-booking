        ...
        <div>
            <Menu mode="horizontal" className='fixed-menu'>
                ...
                <Modal closable={false} title="Are you sure ?" open={isModalOpenDelete} footer={
                    ...
                    <Checkbox onChange={onChangeCheckbox}>Delete approval tasks related to this request.</Checkbox>
                </Modal>
                ...
                <Modal className="select-user-share" style={{ backgroundColor: 'red' }} title="Share" open={isModalOpenShare} footer={
                    <div>
