    ...
    return (
        <div>
            <Menu mode="horizontal" className='fixed-menu'>
                ...
                Trong phiên bản mới của Ant Design, thuộc tính visible được sử dụng thay vì open để kiểm soát việc hiển thị của Modal. Vui lòng chắc chắn rằng bạn đã cập nhật phiên bản Ant Design và sử dụng visible thay vì open để đảm bảo Select hiển thị đúng.
