                    ...
                    <Row>
                        <Col span={12}>
                            <Row className='comment' key={comment.id}>
                                ...
                                {replyComments.filter(reply => reply.parentId === replyComment.id).map((childReply, childIndex) => (
                                    <div>
                                        {replyComments.map((replyComment, index) => (
                                            <Row>
                                                <Col span={12}>
                                                    <Row className='comment' key={replyComment.id}>
                                                        <Col span={2} className="comment-avatar">
                                                            <Avatar size={40} icon={<UserOutlined />} />
                                                        </Col>
                                                        <Col span={19}>
                                             ...
                                             <Row className='reply-comment' key={childReply.id}>
                                             <Col span={2} className="comment-avatar">
                                                 <Avatar size={40} icon={<UserOutlined />} />
                                             </Col>
                                             <Col span={19}>
                                                 <span className="comment-author">{childReply.author}</span>
                                                 <span className="comment-date">{childReply.datetime}</span>
                                                 <div className="comment-content">{childReply.content}</div>
                                             </Col>
                                         </Row>
                                        ))}
                                    </div>
