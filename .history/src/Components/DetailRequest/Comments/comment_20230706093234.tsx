                                ...
                                {showReplyForm && replyToCommentId === comment.id && (
                                    <div className='reply-comment'>
                                        <div className='reply-row'>
                                            ...
                                            <span>
                                                <Button className='btn-comment btn-save' type="primary" onClick={handleSaveComment}>Save</Button>
                                            </span>
                                            <span>
                                ...
                                {comment.replies && comment.replies.map((reply) => (
                                    <div className='reply-comment'>
                                        <div className='reply-row'>
                                            ...
                                            <span className="comment-date">{reply.datetime}</span>
                                            <div className="comment-content">{reply.content}</div>
                                        </div>
                                        {/* Add any additional code for replies here */}
                                    </div>
                                ))}
                            </Row>
                        </Col>
