...
function SendApprover(): JSX.Element {
    ...
    const handleSave = () => {
        ...
        // Xử lý lưu giá trị mới của nhãn (label) ở đây, ví dụ: gửi yêu cầu cập nhật dữ liệu lên máy chủ
    };
                                    ...
                                    <Form.Item
                                        label={
                                            <div>
                                                ...
                                                {isEditing ? (
                                                    <Input value={labelValue} onChange={handleInputChanges} /> // Hiển thị trường nhập liệu khi ở chế độ chỉnh sửa
                                                ) : (
