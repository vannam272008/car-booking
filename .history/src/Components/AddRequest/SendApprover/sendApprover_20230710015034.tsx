...
function SendApprover(): JSX.Element {
    ...
    const [approvers, setApprovers] = useState<Approver[]>([
        { label: "Approver 1", editing: false },
        { label: "Approver 2", editing: false },
        { label: "Approver 3", editing: false }
    ]);
    ...
    const handleSave = (index: number) => {
        const updatedApprovers = [...approvers];
        updatedApprovers[index].editing = false;
        setApprovers(updatedApprovers);
    };

    const handleEdit = (index: number) => {
        const updatedApprovers = [...approvers];
        updatedApprovers[index].editing = true;
        setApprovers(updatedApprovers);
    };
                                                ...
                                                {approver.editing ? (
                                                    <Space>
                                                        <Input
                                                            ...
                                                            onChange={(e) => handleInputChangeApprover(e, index)}
                                                        />
