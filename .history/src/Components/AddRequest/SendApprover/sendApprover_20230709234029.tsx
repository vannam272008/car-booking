                                ...
                                <Col span={8} key={index}>
                                    <Form.Item
                                        label={
                                            <div>
                                                {isEditing ? (
                                                    <Input value={labelValue} onChange={handleInputChangeApprover} /> // Hiển thị trường nhập liệu khi ở chế độ chỉnh sửa
                                                ) : (
                                                ...
                                                {isEditing ? (
                                                    ...
                                                    <div>
                                                        ...
                                                        <span><Button onClick={handleEdit} type="link" icon={<EditOutlined />} /> </span>
                                                        <span>                                                    <Button type="link" icon={<DragOutlined />} />
                                                        </span>
