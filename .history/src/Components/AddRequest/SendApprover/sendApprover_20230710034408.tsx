...
function SendApprover(): JSX.Element {
    ...
    const handleEdit = (index: number) => {
        ...
        if (inputRefs.current[index] && inputRefs.current[index].input) {
            inputRefs.current[index].input.focus();
        }
    };
                                    ...
                                    <Form.Item
                                        label={
                                            <div className='label-approver'>
                                                {editingIndex === index ? (
                                                    <Space>
                                                        <Input ref={(ref) => handleInputRef(index, ref)} value={labelApprovers[index]} onChange={(e) => handleInputChangeApprover(index, e.target.value)} />
                                                        <Button
                                                            type="link"
