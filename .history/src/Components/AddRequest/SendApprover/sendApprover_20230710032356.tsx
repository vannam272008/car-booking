                                ...
                                <Form.Item
                                    label={
                                        <div>
                                            {editingIndex ? (
                                                <Space>
// Truyền đối số index vào handleInputChangeApprover
                                                    <Input value={labelApprovers} onChange={(e) => handleInputChangeApprover(index, e.target.value)} />
                                                    <Button type="link" onClick={() => handleSave} icon={<SaveOutlined />} />
                                                </Space>
                                            ) : (
                                                <Space>
                                                    <span>{labelApprovers}</span>
