...
function SendApprover(): JSX.Element {
    ...
    const [labelApprovers, setLabelApprovers] = useState<string[]>(["Approver"]);

    const handleInputChangeApprover = (e: React.ChangeEvent<HTMLInputElement>) => {
        setLabelApprovers(prevArray => [...prevArray, e.target.value]);
    };
                                        ...
                                        label={
                                            <div>
                                                {editingIndex === index ? (
                                                    <Space>
                                                        <Input
                                                            value={labelApprovers[index]}
                                                            onChange={(e) => handleInputChangeApprover(index, e.target.value)}
                                                        />
