                                    ...
                                    <Row gutter={16}>
                                        ...
                                        {inputs.map((input, index) => (
                                            <Col span={8} key={index}>
                                                ...
                                                >
                                                    <Select
                                                        className={selectedIndices.includes(index) ? 'select-add-request selected' : 'select-add-request'}
                                                        onChange={(value) => handleInputChange(index, value)}
                                                        onFocus={() => setSelectedIndices([...selectedIndices, index])}
                                                        onBlur={() => setSelectedIndices(selectedIndices.filter((i) => i !== index))}
                                                    >
                                                        <Option value="1">bangnm@o365.vn, Developer</Option>
                                                        <Option value="2">thy@o365.vn, Giám đốc tài chính</Option>
                                                    </Select>
