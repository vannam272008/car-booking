                                    ...
                                    <Row gutter={16}>
                                        <Col span={8}>
                                            <Form.Item
                                                ...
                                                labelCol={{ span: 24 }}
                                            >
                                                {/* <label>Pho phong IT<span className='required'>*</span></label> */}
                                                <Select
                                                ...
                                                >
                                                    ...
                                                    <Option value="2"
                                                    >
                                                        thy@o365.vn, Giám đốc tài chính
                                                    </Option>
                                                </Select>
                                            </Form.Item>
                                        </Col>
                                        <Col span={8}>
                                            <Form.Item
                                                ...
                                                labelCol={{ span: 24 }}
                                            >
                                                <label>Approver<span className='required'>*</span></label>
                                                <Select
                                                    className='select-add-request'
                                                >
                                                    <Option
                                            ...
                                            {inputs.map((input, index) => (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <Option
                                                            value="1"
                                                            onChange={(e: string) => handleInputChange(index, e)}
                                                        >
                                                            bangnm@o365.vn, Developer
                                                        </Option>
                                                        <Option value="2"
