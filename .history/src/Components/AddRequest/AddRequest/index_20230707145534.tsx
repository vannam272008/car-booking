...
function AddRequest(): JSX.Element {
    ...
    const [approverValue, setApproverValue] = useState("1");
    setApproverValue(""); // Xóa giá trị được chọn bằng cách gán cho nó giá trị rỗng
                                    ...
                                    <Row gutter={16}>
                                        <Col span={8}>
                                            <Form.Item
                                                ...
                                                labelCol={{ span: 24 }}
                                            >
                                                <Select className='select-add-request' onChange={(value) => setApproverValue(value)}>
