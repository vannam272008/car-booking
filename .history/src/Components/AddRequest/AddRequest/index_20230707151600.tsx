...
function AddRequest(): JSX.Element {
    ...
    const DraggableSelect = ({ index, handleDelete, handleInputChange }) => {
        const [{ isDragging }, drag] = useDrag({
            item: { index, type: 'SELECT' },
            collect: (monitor) => ({
    ...
    const DroppableSelect = ({ index, handleDelete, handleInputChange }) => {
        const [{ canDrop, isOver }, drop] = useDrop({
            accept: 'SELECT',
            drop: () => handleDelete(index),
            collect: (monitor) => ({
        ...
        const backgroundColor = isOver && canDrop ? 'lightgreen' : '';
