                ...
                <Col span={18} className="col-function">
                    <div className="group-btn">
                        <Dropdown
                            ...
                            dropdownRender={() => (
                                <Affix style={{ position: 'absolute', top: 0, right: -200 }} offsetTop={45} onChange={(affixed) => console.log(affixed)}>
                        ...
                        <Dropdown
                            ...
                            dropdownRender={() => (
                                <Affix style={{ position: 'absolute', top: 0, right: -5 }} offsetTop={45} onChange={(affixed) => console.log(affixed)}>
                                    <div className="dropdown-help" style={contentStyle}>
                                        {/* {React.cloneElement(menu as React.ReactElement, { style: menuStyle })} */}
                                        <div className="title-dropdown">
