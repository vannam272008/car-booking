                ...
                <Col span={18} className="col-function">
                    <div className="group-btn">
                        <Dropdown
                            ...
                            dropdownRender={() => (
                                <Affix style={{ position: 'absolute', top: 0, right: -6 }} offsetTop={64} onChange={(affixed) => console.log(affixed)}>
                                    <div className="dropdown-help" style={contentStyle}>
                                        {/* {React.cloneElement(menu as React.ReactElement, { style: menuStyle })} */}
                                        <div className="title-dropdown">
                                            <span>Help</span>
                                            <Button className="header-btn-close" onClick={handleClickHelp} icon={<CloseOutlined />} />
                                        </div>
                        ...
                        <Dropdown
                            ...
                            dropdownRender={() => (
                                <Affix style={{ position: 'absolute', top: 0, right: - }} offsetTop={64} onChange={(affixed) => console.log(affixed)}>
                                    <div className="dropdown-help" style={contentStyle}>
                                        {/* {React.cloneElement(menu as React.ReactElement, { style: menuStyle })} */}
                                        <div className="title-dropdown">
