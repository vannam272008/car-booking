...
const Approving: React.FC = () => {
  ...
  const handleGetApprovingRequest = async () => {
    setLoading(true);
    try {
    ...
    <RequestLayout profile={profile}>
      {() => (
        <div style={{ overflowX: 'hidden' }} className='request'>
          <div className='approving-navbar'>
            <div className='approving-title'>car booking</div>
            <div>
              ...
              <FilterDropdown
                ...
                onApply={handleGetApprovingRequest}
              />
