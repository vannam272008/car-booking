...
const Draft: React.FC = () => {
  ...
  const handleGetDraftRequest = async () => {
    setLoading(true);
    try {
    ...
    <RequestLayout profile={profile}>
      {() => (
        <div style={{ overflowX: 'hidden' }} className='request'>
          <div className='draft-navbar'>
            <div className='draft-title'>car booking</div>
            <div>
